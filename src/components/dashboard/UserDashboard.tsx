...
export function UserDashboard() {
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-xl text-white/60 font-body">Here's what's happening on Marconi today</p>
            </div>
            <StreamPlayer />
          </div>
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-primary-900 to-accent-900">
      ...
      <div className="md:hidden fixed top-16 left-0 right-0 z-40 bg-white/10 backdrop-blur-lg border-b border-white/10">
      ...
      <div className="md:pl-64">
        <main className="pt-16 px-4 pb-20 md:pb-8 min-h-screen">
